...
{
	public class MoveOnlyMinimaxWithAlphaBetaPruningWithPreplacerMoveMaker : IMoveDecisionMaker
	{
		...
		public MoveOnlyMinimaxWithAlphaBetaPruningWithPreplacerMoveMaker(int maxSearchDepth, IUtilityCalculator calculator, PreplacerStrategy preplacer)
		{
